...
type Role struct {
	gorm.Model
	Roleid  int64   `gorm:"type:varchar(255);not null;index:,unique" json:"roleid,string"`
	...
	Users   []*User `gorm:"many2many:user_role;ForeignKey:Roleid;AssociationForeignKey:Userid" json:"users"`
